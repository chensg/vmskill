...
诗词只做竖版。横版模板 make_h.py 2026-09-25 退役（一直是旧模板，缺安全区、
暗角建模、极性翻转、粒子层、pick、素材来源表）；真要横版时从这份移植。
=======================================================================
...
#
# 静帧模式连带三件事（见 references/visuals.md「静帧模式」）：素材分辨率门槛从 1.5 倍降到
...
def valleys(curve, off, total, thr=-25.0, minlen=0.4):
    ...
    references/music.md 里"拿到曲子先翻一遍低谷再决定要不要第二条候选"原来是句手工提醒 ——
